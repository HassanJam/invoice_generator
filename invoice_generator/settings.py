...
SECRET_KEY = 'django-insecure-0595)q=^@^156bvpvx6%b9blhi0#*1s3*w%gvqc_91s&k!2s@8'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / "quotations/static"]
MIDDLEWARE = [
...
USE_TZ = True
LOGIN_REDIRECT_URL = 'quotations/index'
